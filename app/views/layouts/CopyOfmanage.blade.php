...
<head>
  ...
  <link href="{{asset('static/css/style.default.css')}}" rel="stylesheet">
  <link href="{{asset('static/css/jquery.datatables.css')}}" rel="stylesheet">
    ...
    <div class="leftpanelinner">    
        ...
        <div class="visible-xs hidden-sm hidden-md hidden-lg">   
            <div class="media userlogged">
                <img alt="" src="{{asset('static/images/photos/loggeduser.png')}}" class="media-object">
            ...
            <div class="btn-group">
              ...
              <div class="dropdown-menu dropdown-menu-head pull-right">
                ...
                <ul class="dropdown-list user-list">
                  <li class="new">
                    <div class="thumb"><a href=""><img src="{{asset('static/images/photos/user1.png')}}" alt="" /></a></div>
                    <div class="desc">
                      <h5><a href="">Draniem Daamul (@draniem)</a> <span class="badge badge-success">new</span></h5>
                    </div>
                  </li>
                  <li class="new">
                    <div class="thumb"><a href=""><img src="{{asset('static/images/photos/user2.png')}}" alt="" /></a></div>
                    <div class="desc">
                      <h5><a href="">Zaham Sindilmaca (@zaham)</a> <span class="badge badge-success">new</span></h5>
                    </div>
                  </li>
                  <li>
                    <div class="thumb"><a href=""><img src="{{asset('static/images/photos/user3.png')}}" alt="" /></a></div>
                    <div class="desc">
                      <h5><a href="">Weno Carasbong (@wenocar)</a></h5>
                    </div>
                  </li>
                  <li>
                    <div class="thumb"><a href=""><img src="{{asset('static/images/photos/user4.png')}}" alt="" /></a></div>
                    <div class="desc">
                      <h5><a href="">Nusja Nawancali (@nusja)</a></h5>
                    </div>
                  </li>
                  <li>
                    <div class="thumb"><a href=""><img src="{{asset('static/images/photos/user5.png')}}" alt="" /></a></div>
                    <div class="desc">
          ...
          <li>
            <div class="btn-group">
              <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                <img src="{{asset('static/images/photos/loggeduser.png')}}" alt="" />
                John Doe
          ...
          <div class="panel panel-success panel-stat">
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="{{asset('static/images/is-user.png')}}" alt="" />
                  </div>
                  <div class="col-xs-8">
          ...
          <div class="panel panel-danger panel-stat">
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="{{asset('static/images/is-document.png')}}" alt="" />
                  </div>
                  <div class="col-xs-8">
          ...
          <div class="panel panel-dark panel-stat">
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="{{asset('static/images/is-money.png')}}" alt="" />
                  </div>
                  <div class="col-xs-8">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4">
          <div class="panel panel-default widget-photoday">
            <div class="panel-body">
              <a href="" class="photoday"><img src="{{asset('static/images/photos/photo1.png')}}" alt="" /></a>
        ...
        <div class="tab-pane active" id="rp-alluser">
            ...
            <ul class="chatuserlist">
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="{{asset('static/images/photos/userprofile.png')}}" class="media-object">
                        </a>
                        <div class="media-body">
                ...
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="{{asset('static/images/photos/user1.png')}}" class="media-object">
                        </a>
                        <div class="media-body">
                ...
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="{{asset('static/images/photos/user2.png')}}" class="media-object">
                        </a>
                        <div class="media-body">
                ...
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="{{asset('static/images/photos/user3.png')}}" class="media-object">
                        </a>
                        <div class="media-body">
                ...
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="{{asset('static/images/photos/user4.png')}}" class="media-object">
                        </a>
                        <div class="media-body">
            ...
            <ul class="chatuserlist">
                <li>
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="{{asset('static/images/photos/user5.png')}}" class="media-object">
                        </a>
                        <div class="media-body">
                            <strong>Eileen Sideways</strong>
                            <small>Los Angeles, CA</small>
...
<script src="{{asset('static/js/jquery-ui-1.10.3.min.js')}}"></script>
<script src="{{asset('static/js/bootstrap.min.js')}}"></script>
<script src="{{asset('static/js/modernizr.min.js')}}"></script>
<script src="{{asset('static/js/jquery.sparkline.min.js')}}"></script>
<script src="{{asset('static/js/toggles.min.js')}}"></script>
<script src="{{asset('static/js/retina.min.js')}}"></script>
<script src="{{asset('static/js/jquery.cookies.js')}}"></script>

<script src="{{asset('static/js/flot/flot.min.js')}}"></script>
<script src="{{asset('static/js/flot/flot.resize.min.js')}}"></script>
<script src="{{asset('static/js/morris.min.js')}}"></script>
<script src="{{asset('static/js/raphael-2.1.0.min.js')}}"></script>
